...
#define SHKMyAppName			@"Consumer Alert"
#define SHKMyAppURL				@"http://consumeralert.appspot.com"
...
#define SHKFacebookKey				@"d715c60318df413f100909243511e5de"
#define SHKFacebookSecret			@"7341945c6440eb9c99e499b2650365ae"
 ...
 */
#define SHKTwitterConsumerKey		@"EXdYM7DCsu9Ovr3t059p0Q"
#define SHKTwitterSecret			@"qobcOPSDza4OPxLlwXzWLMIAqsjzOUjAsoUjnkKK87M"
#define SHKTwitterCallbackUrl		@"http://consumeralert.appspot.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"jy2947bitly"
#define SHKBitLyKey					@"R_b46cd3a0c7b509d320902d1bc744c94c"
